...
<div>
	<div class="flex gap-2">
		<select
			...
			multiple
			class="styled-scroll mt-1 block w-full rounded-md border border-slate-700 bg-slate-800 px-3 py-2 text-white focus:ring-2 focus:ring-yellow-500 focus:outline-none"
		>
