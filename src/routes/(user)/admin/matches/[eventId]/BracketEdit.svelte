...
<script lang="ts">
	...
	import BracketRoundNodeSelect from './BracketRoundNodeSelect.svelte';
	let {
		stage,
		matches,
	...
	$inspect(`[BracketEdit] initialRounds`, initialRounds);
	$inspect(`[BracketEdit] initialNodes`, initialNodes);
...
<div class="flex h-full flex-col">
	...
	<div class="min-h-0 flex-1">
		<div class="styled-scroll h-full space-y-4 overflow-y-auto pr-2">
			<div class="flex items-center justify-between">
				...
				<BracketRoundNodeSelect {rounds} {nodes} {matches} bind:selectedObject />
			</div>
		...
		<div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
			<div class="rounded-lg border border-slate-700 bg-slate-800 p-6 shadow-xl">
				...
				<div class="flex justify-end gap-3">
					<button
						type="button"
						class="cursor-pointer rounded-md border border-slate-700 px-4 py-2 text-slate-300 hover:bg-slate-700"
					...
					<button
						type="button"
						class="cursor-pointer rounded-md bg-red-600 px-4 py-2 font-medium text-white hover:bg-red-700 focus:ring-2 focus:ring-red-500 focus:outline-none"
						onclick={async () => {
	...
	<div class="mt-6 flex justify-end gap-4 border-t border-slate-700 pt-4">
		...
		<button
			type="button"
			class="cursor-pointer rounded-md bg-yellow-500 px-4 py-2 font-medium text-black hover:bg-yellow-600 focus:ring-2 focus:ring-yellow-500 focus:outline-none"
